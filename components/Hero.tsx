...
function Hero() {
  ...
  return (
    <div className='flex items-end relative ' style={{backgroundImage:'url(https://i.pinimg.com/originals/a0/ea/4c/a0ea4ce1b166c0a6a7cac0d785e35868.gif)',backgroundSize:'cover'}}  >
           {/* Hero Section */}
           <div className='bg-black/40 absolute top-0  right-0 bottom-0 left-0 w-full h-full '></div>
      <main  className=" relative flex flex-col  justify-end text-white   h-[450px] container mx-auto max-w-4xl ">
        <div className="grid md:grid-cols-1 gap-12 w-full  items-center">
          <div>
            ...
            <p ref={subtitleRef} className="text-xl text-gray-300 mb-8">
              Revolutionize your digital Travel Apps using
